...
module.exports = {
	'0102': new SupportCode('Missing name', 'This is likely a Pretendo server issue', 'Missing message.', 'Try double checking your internet connection or wait.', 'https://en-americas-support.nintendo.com/app/answers/detail/a_id/17043/~/error-code%3A-001-0102#:~:text=This%20error%20code%20indicates%20you,a%20poor%20wireless%20network%20environment.'),
	'0112': new SupportCode('Missing name', 'Connection timeout', 'Unable to connect to the server.\nPlease try again later', 'Verify your wifi is working. If it is working, then this is a serverside error. Please wait and try again later.', 'https://en-americas-support.nintendo.com/app/answers/detail/a_id/14458/~/error-code%3A-001-0112'),
